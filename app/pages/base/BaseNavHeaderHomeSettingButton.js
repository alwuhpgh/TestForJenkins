...
export default class BaseNavHeaderHomeSettingButton extends Component {
  // 按钮点击事件
  _btnClick = () => {
    // 发送
    ...
    return (
      ...
      >
        <View style={[styles.btn, this.props.style]}>
          <Image style={styles.btn_image} source={require('./../../img/Common/setting_btn.png')}/>
        </View>
      </TouchableWithoutFeedback>
    )
  }
...
const styles = StyleSheet.create({
  ...
  btn_image: {
    width: myScreenSize.width * 40 / 750,
